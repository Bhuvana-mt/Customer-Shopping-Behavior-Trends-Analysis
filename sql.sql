...
-- 4) compare the avg purchase amount between standars and express shipping.
...
--7) segment customers into new, raturning, and loyal based on their total number of previous purchases, and show the count of each segment.
